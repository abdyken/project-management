...
| US1-3 Combined filters (AND) | PASS | 7 combinations (AND) match: faculty -> 3; degree_level -> 10; language -> 3; faculty+degree_level -> 2; faculty+language -> 1; degree_level+language -> 3; faculty+degree_level+language -> 1 |
